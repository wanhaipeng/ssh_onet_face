...
import os, sys
sys.path.append('./caffe-ssh/python')
...
def parser():
    ...
    parser.add_argument('--o_model',dest='o_model',help='mtcnn Onet caffemodel',
                        default='data/SSH_models/48net.caffemodel',type=str)
    parser.add_argument('--o_proto',dest='o_prototxt',help='mtcnn Onet prototxt',
                        default='SSH/models/48net.prototxt',type=str)
...
if __name__ == "__main__":
    ...
    net.name = 'SSH'
    o_net = caffe.Net(args.o_prototxt, args.o_model, caffe.TEST)
    o_net.name = 'ONet'
    print('Done!')
    ...
    # Perform detection
    cls_dets, times = detect(net, o_net, args.im_path,visualization_folder=args.out_path,visualize=True,pyramid=pyramid)
    print ('times: ', times['detect'].average_time)
